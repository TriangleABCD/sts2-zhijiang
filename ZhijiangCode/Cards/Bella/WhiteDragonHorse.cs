...
// 白龙马（White Dragon Horse）：稀有牌（阴 / 能力）。获得格挡；若队伍中有乃琳，你与乃琳一同回复生命。
[RegisterCard(typeof(BellaCardPool))]
public sealed class WhiteDragonHorse : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"{Entry.ResPath}/images/cards/Bella/white_dragon_horse.png");
    ...
    public WhiteDragonHorse() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
